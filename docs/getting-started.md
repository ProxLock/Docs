...
ProxLock is a secure API proxy service that helps protect your API keys by:
- Splitting your API keys into partial keys that are stored separately
- Proxying API requests through a secure service
- Validating devices using Apple's Device Check framework
